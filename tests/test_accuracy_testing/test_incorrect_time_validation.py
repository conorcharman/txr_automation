...
class TestIncorrectTimeRecord:
    ...
    def test_from_row(self):
        row = ['AA2024A00001', '2024-01-15-09.30.00.000000', 'AA2024A00011', '2024-01-15-09.30.00.000000']
    ...
    def test_to_dict_keys(self):
        ...
        d = record.to_dict()
        assert set(d.keys()) == {
            'child_ref', 'child_datetime', 'parent_ref', 'parent_datetime',
            'bulk_ref', 'time_difference', 'error',
        }
