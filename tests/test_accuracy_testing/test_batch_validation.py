...
from src.accuracy_testing.scripts import (
    buyer_id_validation,
...
class TestBatchValidationDetection:
    ...
    def test_detects_batch_mode_with_incidents_and_testing_period(self):
        ...
        config = {
            ...
            "batch": {
                ...
                "testing_period": {"fiscal_year": "FY25", "quarter": "Q3"},
                "paths": {
        ...
        is_batch = (
            "batch" in config
            and "incidents" in config.get("batch", {})
            and "testing_period" in config.get("batch", {})
        )
    ...
    def test_detects_single_mode_without_testing_period(self):
        ...
        config = {
            ...
            "paths": {"template_dir": "data/templates", "output_dir": "data/validated"},
        }
...
class TestBatchFileNaming:
    ...
    def test_multiple_incident_filenames(self):
        ...
        for incident, exp_template, exp_output in zip(
            incidents, expected_templates, expected_outputs
        ):
...
class TestBuyerBatchValidation:
    ...
    def create_buyer_template(
        self, fiscal_year: str, quarter: str, incident: str
    ) -> Path:
...
"""
    ...
    def test_processes_single_incident(self):
        ...
        config = {
            ...
            "processor": {"log_level": "ERROR"},  # Suppress output
        }

        # Run batch validation
        result = buyer_id_validation.run_batch_validation(
            config, dry_run=False, show_progress=False
        )
...
"""
        ...
        # Run batch validation
        buyer_id_validation.run_batch_validation(
            config, dry_run=False, show_progress=False
        )
...
"""
    ...
    def test_processes_multiple_incidents(self):
        ...
        result = seller_id_validation.run_batch_validation(
            config, dry_run=False, show_progress=False
        )
...
"""
    ...
    def test_processes_multiple_incidents(self):
        ...
        result = incorrect_net_amount_validation.run_batch_validation(
            config, dry_run=False, show_progress=False
        )
...
"""
    ...
    def test_dry_run_does_not_create_output(self):
        ...
        # Run in dry run mode
        buyer_id_validation.run_batch_validation(
            config, dry_run=True, show_progress=False
        )
...
class TestBatchValidationErrorHandling:
    ...
    def test_returns_error_code_when_no_incidents(self):
        ...
        config = {
            ...
            "paths": {"template_dir": "data/templates", "output_dir": "data/output"},
        }
