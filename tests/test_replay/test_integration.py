...
class TestPhase2Integration:
    ...
    def test_phase2_applies_correction_with_agree_y(self, temp_dirs):
        ...
        incident_data = [["TXN001", "Y", "CorrectedValue", "FieldName", "Y", "", ""]]
        self.create_incident_file(temp_dirs["incident_files"], "7_39", incident_data)

        # Create replay file
        replay_data = [["7_39", "TXN001"]]  # [incident_code, transaction_ref]
        self.create_replay_file(
            temp_dirs["replay_input"], "test_replay.csv", replay_data
        )
    ...
    def test_phase2_applies_suggested_when_disagree(self, temp_dirs):
        ...
        # Create replay file
        replay_data = [["7_40", "TXN002"]]  # [incident_code, transaction_ref]
        self.create_replay_file(
            temp_dirs["replay_input"], "test_replay2.csv", replay_data
        )
    ...
    def test_phase2_no_change_when_disagree_no_suggestion(self, temp_dirs):
        ...
        # Create incident file
        incident_data = [["TXN003", "Y", "OriginalValue", "OriginalField", "N", "", ""]]
        self.create_incident_file(temp_dirs["incident_files"], "7_41", incident_data)

        # Create replay file
        replay_data = [["7_41", "TXN003"]]  # [incident_code, transaction_ref]
        self.create_replay_file(
            temp_dirs["replay_input"], "test_replay3.csv", replay_data
        )
    ...
    def test_phase2_multiple_incident_codes(self, temp_dirs):
        ...
        incident_data_1 = [["TXN004", "Y", "Value1", "Field1", "Y", "", ""]]
        self.create_incident_file(temp_dirs["incident_files"], "7_39", incident_data_1)

        incident_data_2 = [["TXN004", "Y", "Value2", "Field2", "P", "", ""]]
        self.create_incident_file(temp_dirs["incident_files"], "7_40", incident_data_2)

        # Create replay file with multiple incident codes
        replay_data = [["7_39|7_40", "TXN004"]]  # [incident_codes, transaction_ref]
        self.create_replay_file(
            temp_dirs["replay_input"], "test_replay4.csv", replay_data
        )
