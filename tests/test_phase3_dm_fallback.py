...
def _make_incident_index(header, data_rows, column_config):
    ...
    idx.column_mapper = IncidentColumnMapper(header, column_config, logger=_null_logger())
...
_HEADER = [
    ...
    'Correction', 'Correction Field', 'Agree With Correction',
    'Suggested Correction', 'Suggested Correction Field',
    'Buyer identification code', 'Buyer - First name(s)', 'Buyer - Surname(s)',
    'Buyer - Date of birth',
    'Seller identification code', 'Seller - First name(s)', 'Seller - Surname(s)',
    'Seller - Date of birth',
    'Buyer decision maker code', 'Buy decision maker - First name(s)',
    'Buy decision maker - Surname(s)', 'Buy decision maker - Date of birth',
    'Seller decision maker code', 'Sell decision maker - First name(s)',
    'Sell decision maker - Surname(s)', 'Sell decision maker - Date of birth',
    'Error',
]
...
class TestIncidentFileIndexDMIdFallback:
    ...
    def test_buyer_dm_id_multi_match_disambiguates_by_name(self):
        ...
        result = idx.lookup_by_id(['DM_SHARED'], client_first='Bob', client_surname='Smith')
    ...
    def test_seller_dm_id_multi_match_disambiguates_by_name(self):
        ...
        result = idx.lookup_by_id(['SELL_DM'], client_first='Dave', client_surname='Jones')
