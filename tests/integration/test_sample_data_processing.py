...
HAS_SAMPLE_DATA = (SAMPLE_DATA_DIR / "incident_code_files").exists() and (
    SAMPLE_DATA_DIR / "phase_ii"
).exists()
...
class TestPhase2ProcessorWithSampleData:
    ...
    def test_sample_data_files_exist(self):
        ...
        assert (
            incident_dir.exists()
        ), f"Incident files directory not found: {incident_dir}"
    ...
    def test_phase2_sample_file_structure(self):
        ...
        phase2_file = (
            SAMPLE_DATA_DIR
            / "phase_ii"
            / "1903a~G14~P2_8-19~12_1~KR Final Analysis_Data_1 OF 1_anon_sample.csv"
        )
    ...
    def test_incident_file_structure(self):
        ...
        incident_file = (
            SAMPLE_DATA_DIR / "incident_code_files" / "FY25 Q3 - 12_1_anon_sample.csv"
        )
...
"""
        ...
        assert (
            "Loading incident files" in log_content or "incident" in log_content.lower()
        )
...
"""
        ...
        assert (
            "error" not in result.stderr.lower() or "KeyError" not in result.stderr
...
class TestDataIntegrity:
    ...
    def test_sample_data_character_encoding(self):
        ...
        with open(incident_file, "r", encoding="latin-1") as f:
            ...
            assert (
                chr(172) in content or ":" in content
        ...
        with open(incident_file, "r", encoding="latin-1") as f:
            ...
            for row in rows:
                ...
                if correction and correction != "NULL" and len(correction) > 0:
                    ...
                    assert (
                        chr(172) in correction
                        or ":" in correction
                        or "NULL" in correction
