...
class TestConfigurationLoading:
    ...
    def test_phase3_final_config_from_yaml(
        self, sample_phase3_final_config, temp_data_dir
    ):
    ...
    def test_config_merge_yaml_and_env(
        self, sample_phase2_config, clean_env, temp_data_dir
    ):
...
class TestProcessorConfig:
    ...
    def test_processor_config_valid(self):
        ...
        config_dict = {"processing": {"batch_size": 100, "log_level": "DEBUG"}}
    ...
    def test_processor_config_invalid_batch_size(self):
        ...
        config_dict = {"processing": {"batch_size": 0}}  # Invalid: must be > 0
    ...
    def test_processor_config_invalid_log_level(self):
        ...
        config_dict = {"processing": {"log_level": "INVALID"}}  # Not a valid log level
