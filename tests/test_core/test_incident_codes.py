...
class TestIncidentCodeMatrix:
    ...
    def test_specific_known_mappings(self):
        ...
        assert (
            INCIDENT_CODE_MATRIX["7_35"]["description"]
            == "Incorrect CONCAT value within Buyer identification code field"
        )
        ...
        assert (
            INCIDENT_CODE_MATRIX["16_21"]["description"]
            == "Incorrect NIDN value within Seller identification code field"
        )
