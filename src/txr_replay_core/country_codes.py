...
# Complete country code dataset - 250 countries
COUNTRIES = [
...
class CountryDataManager:
    ...
    def get_by_alpha2(self, code: str) -> Optional[Country]:
        ...
        Args:
            code: Two-letter country code (e.g., "GB", "US")
    ...
    def get_by_alpha3(self, code: str) -> Optional[Country]:
        ...
        Args:
            code: Three-letter country code (e.g., "GBR", "USA")
    ...
    def get_eea_countries(self) -> List[Country]:
        ...
        Returns:
            List of Country objects for EEA members
        """
