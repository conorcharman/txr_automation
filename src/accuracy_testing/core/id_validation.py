...
from .validators import ValidationResult, validate_length, validate_not_empty
...
class IDValidationResult:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"IDValidationResult({status}, id={self.id_value!r}, "
...
class IDValidator:
    ...
    def validate(
        self, country_code: str, id_type: str, id_value: str, strict: bool = True
    ) -> IDValidationResult:
        """
        ...
        is_valid, error_detail = self.format_manager.validate_with_details(
            country_code or "", id_type, id_value
        )
        if not is_valid:
            ...
            result.add_error(
                error_detail
                if error_detail
                else f"ID value does not match {id_type} format for country {country_code}"
            )
    ...
    def validate_auto_detect(
        self, country_code: str, id_value: str
    ) -> IDValidationResult:
        """
    ...
    def validate_lei(self, lei_value: str) -> IDValidationResult:
        ...
        """
        result = IDValidationResult(is_valid=True, id_value=lei_value, id_type="LEI")
    ...
    def validate_batch(
        self, validations: List[Tuple[str, str, str]]
...
def validate_id(
    country_code: str, id_type: str, id_value: str, strict: bool = True
) -> IDValidationResult:
    """
