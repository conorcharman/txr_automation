-- Period Extract: Non-Zero Net Amount Validation
-- Template variables: {START_DATE}, {END_DATE} (YYYY-MM-DD format)
-- Purpose: Extract all Non-Zero Net Amount transactions for a date range
-- Replaces: NonZeroNetAmount.sql
-- Version: 1.0
--
...
SELECT
    c.child_ref,
    t2.NETAMT     AS child_netamt,
    c.parent_ref,
    t3.NETAMT     AS parent_netamt,
