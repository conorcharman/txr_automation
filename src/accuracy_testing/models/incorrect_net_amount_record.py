...
class IncorrectNetAmountRecord:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "IncorrectNetAmountRecord":
        ...
        raw_instrument = (
            data.get("INSTRUMENT")
            or data.get("instrument_classification")
            or data.get("Instrument Classification")
        )
        instrument_classification = (
            str(raw_instrument).strip() if raw_instrument is not None else None
        )
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"IncorrectNetAmountRecord(ref={self.transaction_ref}, "
