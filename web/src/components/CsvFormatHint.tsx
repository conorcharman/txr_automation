  ...
  return (
    <div className="rounded-md border border-blue-200 bg-blue-50 text-sm dark:border-blue-800 dark:bg-blue-900/20">
      <button
        ...
        className="flex w-full items-center gap-2 rounded-sm px-3 py-2 text-xs font-medium text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 dark:text-blue-300"
        aria-expanded={open}
      ...
      {open && (
        <div
          ...
          role="region"
          aria-label={title}
          className="border-t border-blue-200 px-3 pb-3 pt-2 dark:border-blue-800">
