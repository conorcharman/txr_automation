...
class DRRComplianceCheckRequest(_CamelModel):
    ...
    executing_entity_id: str | None = Field(
        None, description="LEI of the executing firm (Field 4)"
    )
    is_investment_firm: str | None = Field(None, description="true or false (Field 5)")
    buyer_id: str | None = Field(
        None, description="Buyer identification code (Field 7)"
    )
    buyer_id_type: str | None = Field(
        None, description="Buyer ID type: LEI, CONCAT, NIDN, CCPT, INTC, BIC"
    )
    seller_id: str | None = Field(
        None, description="Seller identification code (Field 16)"
    )
    seller_id_type: str | None = Field(None, description="Seller ID type")
    transmission_of_order: str | None = Field(
        None, description="true or false (Field 25)"
    )
    trading_date_time: str | None = Field(
        None, description="ISO 8601 trade datetime (Field 28)"
    )
    trading_capacity: str | None = Field(
        None, description="DEAL, MTCH, or AOTC (Field 29)"
    )
    quantity: float | None = Field(
        None, description="Number of units / notional (Field 30)"
    )
    ...
    isin: str | None = Field(
        None, description="ISIN of the financial instrument (Field 41)"
    )
    instrument_full_name: str | None = Field(
        None, description="Full instrument name (Field 42)"
    )
    instrument_classification: str | None = Field(
        None, description="CFI code — 6 uppercase letters (Field 43)"
    )
    notional_currency_1: str | None = Field(
        None, description="ISO 4217 currency code (Field 44)"
    )
    price_multiplier: float | None = Field(
        None, description="Number of underlying units per contract (Field 46)"
    )
    maturity_date: str | None = Field(
        None, description="YYYY-MM-DD maturity date for debt instruments (Field 54)"
    )
    investment_decision_maker: str | None = Field(
        None, description="Decision maker code (Field 57)"
    )
    investment_decision_country: str | None = Field(
        None, description="ISO 3166-1 alpha-2 country code (Field 58)"
    )
    execution_within_firm: str | None = Field(
        None,
        description="Person or algorithm code responsible for execution (Field 59)",
    )
    execution_country: str | None = Field(
        None, description="ISO 3166-1 alpha-2 country code for execution (Field 60)"
    )
    sft_indicator: str | None = Field(
        None, description="true or false — SFT exemption indicator (Field 65)"
    )
