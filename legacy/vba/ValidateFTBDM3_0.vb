Sub ValidateDecisionMaker3_0()
    ...
    Const COL_BUYER_CODE = 3
    Const COL_BUYER_CODE_TYPE = 4
    Const COL_BUYER_DM_CODE = 5
    Const COL_BUYER_DM_CODE_TYPE = 6
    Const COL_PRODUCT = 7
    ...
    For i = 2 To lastRow
        ...
        wsClient.Cells(i, COL_BUYER_CODE_TYPE).Value = buyerCodeType
        wsClient.Cells(i, COL_BUYER_DM_CODE_TYPE).Value = buyerDMCodeType
